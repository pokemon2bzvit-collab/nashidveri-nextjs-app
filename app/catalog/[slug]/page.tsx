...
import { Check, ChevronLeft, ExternalLink, Phone } from "lucide-react";
...
export default async function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const benefits = product.features.filter((feature) => !/^(фабрика|колекція)\b/i.test(feature.trim()));
