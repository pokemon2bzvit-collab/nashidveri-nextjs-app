...
export const entranceBrands: EntranceBrand[] = [
  { slug: "abwehr", name: "Abwehr", description: "Вхідні двері для квартири та приватного будинку.", collections: ["Квартира", "Склад"], image: "/catalog-assets/products/product-1.webp" },
  { slug: "strazh", name: "Страж", description: "Серії вхідних дверей для квартири та вулиці.", collections: ["Вулиця", "Квартира", "Склад"], image: "/catalog-assets/products/product-256.webp" },
