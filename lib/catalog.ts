...
export type Product = { slug: string; category: Category; name: string; material: string; style: string; price: string; description: string; features: string[]; image: string };
...
export const products: Product[] = [
  { slug: "linea-02", category: "interior", name: "Linea 02", material: "Екошпон", style: "Сучасний", price: "від 6 450 грн", description: "Лаконічна модель для світлих сучасних інтер’єрів.", features: ["МДФ", "Екошпон", "Білий дуб"], image: "https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?auto=format&fit=crop&w=900&q=80" },
  { slug: "classic-4", category: "interior", name: "Classic 4", material: "Шпон", style: "Класичний", price: "від 9 800 грн", description: "Виразна класика з теплою текстурою натурального дерева.", features: ["Масив", "Шпон", "Горіх"], image: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=900&q=80" },
  { slug: "loft-glass", category: "interior", name: "Loft Glass", material: "МДФ", style: "Лофт", price: "від 8 250 грн", description: "Графічна дверна конструкція зі скляною вставкою.", features: ["МДФ", "Скло", "Антрацит"], image: "https://images.unsplash.com/photo-1600210491369-e753d80a41f3?auto=format&fit=crop&w=900&q=80" },
  { slug: "fortis-thermo", category: "entrance", name: "Fortis Thermo", material: "Сталь", style: "Сучасний", price: "від 22 900 грн", description: "Надійні двері для квартири чи приватного будинку.", features: ["Сталь", "86 мм", "3 контури ущільнення"], image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=900&q=80" },
  { slug: "safe-house", category: "entrance", name: "Safe House", material: "Сталь", style: "Класичний", price: "від 27 500 грн", description: "Посилена конструкція, продумана для безпеки та тиші.", features: ["Сталь", "МДФ накладка", "2 замки"], image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=900&q=80" },
  { slug: "guardian-100", category: "entrance", name: "Guardian 100", material: "Терморозрив", style: "Сучасний", price: "від 31 800 грн", description: "Модель із терморозривом для максимально теплого входу.", features: ["Терморозрив", "Шумоізоляція", "100 мм"], image: "https://images.unsplash.com/photo-1600607688960-e095ff83135c?auto=format&fit=crop&w=900&q=80" },
