...
export const interiorBrands: InteriorBrand[] = [
  ...
  { slug: "rodos", name: "Rodos", description: "Міжкімнатні двері з акцентом на дизайн, покриття та практичність, зокрема лінійки RODOS Grand.", collections: ["Atlantic ПВХ", "Cortes фарба", "Loft фарба", "Loft шпон", "Royal шпон", "Siena фарба", "Style ПВХ", "Woodmix", "Modern", "Liberta", "Gamma", "Fresca", "DELUX", "LUX", "Paint"], image: "/catalog-assets/products/product-180.jpg" },
