...
export const interiorBrands: InteriorBrand[] = [
  { slug: "papa-carlo", name: "Papa Carlo", description: "Сучасні міжкімнатні двері з екошпону та продуманими декоративними рішеннями.", collections: ["Tetra", "Plato", "Milenium", "Style", "Склад"], image: "/catalog-assets/products/product-85.jpg" },
