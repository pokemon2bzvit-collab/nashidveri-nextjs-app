...
export const interiorBrands: InteriorBrand[] = [
  { slug: "papa-carlo", name: "Папа Карло", description: "Сучасні міжкімнатні двері з екошпону та продуманими декоративними рішеннями.", collections: ["Tetra", "Plato", "Millenium", "IDOORS", "Прихованого монтажу", "STYLE"], image: "https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?auto=format&fit=crop&w=1200&q=80" },
