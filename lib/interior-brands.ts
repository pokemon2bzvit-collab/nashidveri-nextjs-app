...
export const interiorBrands: InteriorBrand[] = [
  ...
  { slug: "rodos", name: "Rodos", description: "Міжкімнатні двері з акцентом на дизайн, покриття та практичність, зокрема лінійки RODOS Grand.", collections: ["Atlantic ПВХ", "Cortes фарба", "Loft фарба", "Loft шпон", "Royal шпон", "Siena фарба", "Style ПВХ", "Woodmix", "Modern", "Liberta", "DELUX", "LUX", "Paint", "Linea"], image: "/catalog-assets/products/product-180.jpg" },
  ...
  { slug: "terminus", name: "Термінус", description: "Фабрика міжкімнатних дверей із різними стилями та видами оздоблення.", collections: ["Caro", "Elit plus", "FREZZATO", "Light", "NEO-CLASSICO", "Solid"], image: "/catalog-assets/products/product-295.webp" },
  ...
  { slug: "kfd", name: "KFD", description: "Міжкімнатні двері української фабрики з Корюківки: ПВХ-плівка, ламінатин, скло та різні варіанти погонажу.", collections: ["KFD"], image: "https://market-dveri.ua/image/catalog/product/mizhkimnatni-dveri/kfd/10094/dveri-kfd-alliance-main.jpg" },
  { slug: "korfad", name: "KORFAD", description: "Актуальний офіційний каталог фабрики з Корюківки: збірні та каркасно-щитові міжкімнатні двері з точними заводськими декорами й варіантами скла.", collections: ["ALIANO", "ALUMINIUM LOFT PLATO", "BELLA", "CLASSICO", "Сосна", "DECO LOFT PLATO", "EXELLENCE"], image: "https://korfad.com.ua/content/images/31/835x1800l80mc0/43261496172109.webp" },
];
