-- Публікація перевірених офіційних моделей Magda 319 патина, 204 патина та 300.
...
where slug in ('magda-319-patina-official', 'magda-204-patina-official', 'magda-300-official')
