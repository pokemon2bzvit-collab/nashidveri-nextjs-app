-- Публікація перевірених офіційних моделей Magda 613 і 614.
...
begin
  ...
  where p.slug in ('magda-613-official', 'magda-614-official')
...
where slug in ('magda-613-official', 'magda-614-official')
