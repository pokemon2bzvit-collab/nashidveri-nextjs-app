-- Публікація перевірених офіційних моделей Magda зі сторінки 10.
...
where slug in ('magda-536-1-official','magda-544-1-official','magda-654-1-official','magda-541-1-official','magda-546-1-official','magda-834-1-official')
