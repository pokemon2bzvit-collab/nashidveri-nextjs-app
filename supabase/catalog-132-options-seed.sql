-- Варіанти, підтверджені офіційною сторінкою Papa Carlo: https://papa-carlo.com.ua/ua/dverne-polotno-t-00f/
...
values
('catalog-132', 'color', 'Колір полотна', 'альпійський білий', null, null, 0),
('catalog-132', 'color', 'Колір полотна', 'сірий матовий', null, null, 1),
('catalog-132', 'color', 'Колір полотна', 'кремовий матовий', null, null, 2)
