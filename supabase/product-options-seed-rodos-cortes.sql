-- Підтверджена палітра фарбованої колекції RODOS Cortes.
-- Джерело: офіційний конструктор моделі Cortes Prima на rodos.ua.
-- Прив'язки кольору до окремого фото виробник не публікує.
...
where product.brand = 'Rodos' and product.collection = 'Cortes фарба'
