-- Варіанти, підтверджені офіційною сторінкою Papa Carlo: https://papa-carlo.com.ua/ua/dverne-polotno-t-14/
...
values
('catalog-128', 'color', 'Колір полотна', 'альпійський білий', null, null, 0),
('catalog-128', 'color', 'Колір полотна', 'сірий матовий', null, null, 1),
('catalog-128', 'color', 'Колір полотна', 'кремовий матовий', null, null, 2)
