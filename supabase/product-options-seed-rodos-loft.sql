-- Палітра фарбованої колекції RODOS Loft.
-- Підтверджено офіційним каталогом RODOS: білий мат і фарбування за RAL.
-- Шпонований Loft Surf не входить у цей скрипт — він має окрему палітру.
...
where product.brand = 'Rodos' and product.collection = 'Loft фарба'
