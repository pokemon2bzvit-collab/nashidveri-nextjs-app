...
function FooterNavigationLabel({ label }: { label: string }) {
  if (label === "Міжкімнатні двері") return <><span className="lg:hidden">Міжкімнатні</span><span className="hidden lg:inline">Міжкімнатні двері</span></>;
  if (label === "Вхідні двері") return <><span className="lg:hidden">Вхідні</span><span className="hidden lg:inline">Вхідні двері</span></>;
  return label;
}
